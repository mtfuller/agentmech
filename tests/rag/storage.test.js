...
describe('RAG Storage Formats', () => {
  ...
  test('Create and save embeddings in MessagePack format', async () => {
  ...
  test('Load embeddings from MessagePack format', async () => {
  ...
  test('Create and save embeddings in JSON format', async () => {
  ...
  test('MessagePack should be smaller than JSON', () => {
    const msgpackPath = path.join(testDir, 'test-embeddings.msgpack');
    const jsonPath = path.join(testDir, 'test-embeddings.json');
  ...
  test('Test migration from JSON to MessagePack', async () => {
